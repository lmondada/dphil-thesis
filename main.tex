...
\title{Scaling Up Quantum Compilation}
\author{Luca M Mondada}
...
%%%%% YOUR OWN PERSONAL MACROS / stuff
...
\include{text/ch3-quantumsuper}
\include{text/ch4-pattern}
\include{text/ch5-zx}
\include{text/ch6-futcompiler}
